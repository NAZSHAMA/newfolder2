...
export default function Header2(){
    return(
        <div>
            <header className='flex shadow-[0px_0px_16px_rgba(17,_17,_26,_0.1)] py-4 px-4 sm:px-6 bg-white font-sans text-2xl min-h-[70px] tracking-wide relative z-50'>
      <div className='flex flex-wrap items-center justify-between gap-4 w-full max-w-screen-xl mx-auto'>
     <Link href=""> <img src='c:\Users\hp\Desktop\New folder (4)temp8\my-app\Vector (1).png
'alt=" "></img> Comforty</Link>
       ...
       <div className='flex items-center max-lg:ml-auto space-x-5'>
          <button type="button" className="bg-gray-600 gray:bg-blue-700 px-3.5 py-[7px] rounded text-white text-[15px] font-semibold flex items-center justify-center gap-2">
